...
| **改进目标** | 应该改的具体文件路径（如 `.claude/skills/feature-workflow/references/coding.md`），用于后续按目标分组触发进化 |
...
| 记忆主题 | 状态 | 利用次数 | 漏用次数 | 本次利用场景 | 评估 |
|---------|------|---------|---------|------------|------|
| <主题> | <有效/过时/待验证> | N | N | <在什么任务/步骤中用了这条记忆，解决了什么问题> / 未使用 | <记对了帮助到了 / 应该用但漏了 / 信息已过时> |
