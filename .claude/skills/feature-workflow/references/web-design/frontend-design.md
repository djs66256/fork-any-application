# frontend-design — Web 端技术方案设计参考

> 本文件为 Web 端技术方案设计的参考指南，由**主 agent** 直接执行撰写。
...
3. 调用 `Skill("llm-wiki")` 加载规范，查阅 Web 端相关功能文档和已有架构
...
按 `assets/design-web-template.md` 模板，撰写 Web 端技术方案，
