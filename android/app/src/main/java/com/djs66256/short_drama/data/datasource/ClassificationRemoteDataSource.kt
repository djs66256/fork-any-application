...
@Singleton
class ClassificationRemoteDataSource @Inject constructor(
    private val apiService: ApiService,
    private val json: Json,
) {
    suspend fun getClassificationTags(gender: String): ApiResult<ClassificationTagsResponseDto> = execute {
        apiService.getDramaTags(gender = gender)
    }
