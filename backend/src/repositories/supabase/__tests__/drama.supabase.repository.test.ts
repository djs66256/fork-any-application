...
describe('DramaSupabaseRepository', () => {
  ...
  it('findMany should map legacy supabase rows to canonical paginated results', async () => {
    ...
    expect(builder.select).toHaveBeenCalledWith(
      'id,title,description,cover_url,category,episode_count,rating,created_at,updated_at,tags',
  ...
  it('listRankings should map ranking fields and booking state', async () => {
    ...
    expect(rankingBuilder.select).toHaveBeenCalledWith(
      'id,title,description,cover_url,category,episode_count,rating,created_at,updated_at,tags,content_type,play_count,booking_count,recommendation_score',
      { count: 'exact', head: false },
    );
